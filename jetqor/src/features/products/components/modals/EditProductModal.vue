...
const formData = ref({
  ...
  width: props.product.width.toString(),
  height: props.product.height.toString(),
  length: props.product.length.toString(),
  weight: props.product.weight.toString(),
  price: props.product.price.toString(),
});

const volume = computed(() => {
  return Number(formData.value.width) * Number(formData.value.height) * Number(formData.value.length);
});
  ...
  try {
    const response = await api(`/product/update`, {
      ...
      body: {
        ...
        photo_url: formData.value.photo_url || props.product.photo_url,
